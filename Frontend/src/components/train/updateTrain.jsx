    ...
    return (
      <div className="admin-main">
        ...
        <form id="form" onSubmit={this.submit}>
          ...
          <input type="number" name="train_no" id="train_no" value={this.state.train_no} onChange={this.handleChange} />
          <label htmlFor="available_tiers">Available Tiers : </label>
          <div>
            <input type="checkbox" name="available_tiers" id="available_tiers" value="1A" onChange={this.handleChange} />1A
            <input type="checkbox" name="available_tiers" id="available_tiers" value="2A" onChange={this.handleChange} />2A
            <input type="checkbox" name="available_tiers" id="available_tiers" value="3A" onChange={this.handleChange} />3A
            <input type="checkbox" name="available_tiers" id="available_tiers" value="SL" onChange={this.handleChange} />SL
            <input type="checkbox" name="available_tiers" id="available_tiers" value="CC" onChange={this.handleChange} />CC
          </div>
          <label htmlFor="departing_days">Select departing days : </label>
          <div>
            <input type="checkbox" name="departing_days" id="departing_days" value="mon" onChange={this.handleChange} />Monday
            <br />
            <input type="checkbox" name="departing_days" id="departing_days" value="tue" onChange={this.handleChange} />Tuesday
            <br />
            <input type="checkbox" name="departing_days" id="departing_days" value="wed" onChange={this.handleChange} />Wednesday
            <br />
            <input type="checkbox" name="departing_days" id="departing_days" value="thu" onChange={this.handleChange} />Thursday
            <br />
            <input type="checkbox" name="departing_days" id="departing_days" value="fri" onChange={this.handleChange} />Friday
            <br />
            <input type="checkbox" name="departing_days" id="departing_days" value="sat" onChange={this.handleChange} />Saturday
            <br />
            <input type="checkbox" name="departing_days" id="departing_days" value="sun" onChange={this.handleChange} />Sunday
            <br />
          </div>
          ...
          <input type="number" name="ticket_cost" id="ticket_cost" value={this.state.ticket_cost} onChange={this.handleChange} />
          <div />
